module.exports = {
        dbCreation : [
                ...
                createSearchesTable = "CREATE TABLE IF NOT EXISTS searches ( search_id text PRIMARY KEY, keywords text );",
                createJobPostingsTable = "CREATE TABLE IF NOT EXISTS job_postings ( id integer PRIMARY KEY, parent_search_id text NOT NULL, title text, company text, description text, location text, post_date text, latitude text, longitude text, url text, category text, FOREIGN KEY(parent_search_id) REFERENCES searches(search_id) );",
        ...
        transactions : {
                ...
                insertNewSearch : 'INSERT INTO searches (search_id, keywords) VALUES (?, ?);',
